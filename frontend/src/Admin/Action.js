...
function Action() {
    ...
    const filter1 = filterseller.filter((item)=> item.authorization === true)
    ...
    return (
        <div className="flex flex-col">
            <h2 className="text-center text-4xl font-extrabold font-mono">Unblock Seller's</h2>
                                    ...
                                    return (
                                        <tr className="border-b dark:border-neutral-500">
                                            ...
                                            <td className="whitespace-nowrap  px-6 py-4">
                                                ...
                                                <input type="checkbox" className="checkbox"   onClick={()=>{setsenddata(!senddata);handletoggle(item.email)}} />
                                            </td>
                                        </tr>
                                    )
                                })}
